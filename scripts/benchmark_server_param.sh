...
export VLLM_FAKE_SEND_RECV=${VLLM_FAKE_SEND_RECV:-0}
export VLLM_REPLACE_SEND_RECV_WITH_ALL_REDUCE=${VLLM_REPLACE_SEND_RECV_WITH_ALL_REDUCE:-0}
export VLLM_FAKE_ALL_GATHER=${VLLM_FAKE_ALL_GATHER:-0}
export VLLM_PP_ALL_GATHER_USE_GLOO=${VLLM_PP_ALL_GATHER_USE_GLOO:-0}
export VLLM_ALL_REDUCE_NO_MARK_STEP=${VLLM_ALL_REDUCE_NO_MARK_STEP:-0}
export VLLM_ALL_GATHER_NO_MARK_STEP=${VLLM_ALL_GATHER_NO_MARK_STEP:-0}
