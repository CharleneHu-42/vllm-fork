...
class LLMEngine:
    ...
    def __init__(
        ...
        #Dlogger.info(f"[STACK_TRACE] LLMEngine.__init__.start")
        ...
        #Dlogger.info(f"[STACK_TRACE] LLMEngine.__init__.end")
    ...
    def _initialize_kv_caches(self) -> None:
        ...
        """
        #Dlogger.info(f"[STACK_TRACE] LLMEngine._initialize_kv_caches.start")
        start = time.time()
        ...
        #Dlogger.info(f"[STACK_TRACE] LLMEngine._initialize_kv_caches.end")
    ...
    def step(self) -> List[Union[RequestOutput, PoolingRequestOutput]]:
        ...
        Example:
            ...
            >>>         break
        """
        #Dlogger.info(f"[STACK_TRACE] LLMEngine.step.start")
        ...
        if not self._has_remaining_steps(seq_group_metadata_list):
            ...
            # Multi-step case
            #Dlogger.info(f"[STACK_TRACE] LLMEngine.step.end_1")
        ...
        #Dlogger.info(f"[STACK_TRACE] LLMEngine.step.end_2")
        return ctx.request_outputs
